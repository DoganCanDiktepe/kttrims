/*Slide hover*/
$('.tms-caption .interactive-link a').hover(function() {
	var myEm = $(this).attr('data-id');
	$('li[data-id = '+myEm+']').toggleClass('show'),3000;
});


/*Text Hover*/
{
	const items = Array.from(document.querySelectorAll('.interactive-link > a'));

	class Item {
		constructor(el) {
			this.DOM = {};
			this.DOM.el = el;
			this.DOM.label = el.querySelector('.labels');
			this.colors = {
