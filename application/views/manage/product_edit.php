                        ...
                        <form class="" method="POST" role="form">
                            ...
                            <div class="form-group ">
                                ...
                                <select class="full-width" data-init-plugin="select2" name="lang_id">
                                    ...
                                    <?php foreach (langList() as $k => $v) { ?>
                                        <option <?php echo ($v['id'] == $detail['lang_id']) ? 'selected="selected"' : ''; ?>
                            ...
                            <div class="form-group required fileinput-box">
                                ...
                                <input type="hidden" name="picture"
                                       value='<?php echo (count($detail['picture'])) ? $detail['picture'] : ''; ?>'/>
                                <div class="clearfix"></div>
                            </div>
                            <div class="form-group ">
                                ...
                                <select class="full-width" data-init-plugin="select2" name="category_id">
                                    ...
                                    <?php foreach ($categoryList as $k => $v) { ?>
                                        <option <?php echo ($v['id'] == $detail['category_id']) ? 'selected="selected"' : ''; ?>
                                            value="<?php echo $v['id']; ?>"><?php echo $v['title']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group form-group-default required ">
                                <label>Başlık</label>
                                <input type="text" name="title" onkeyup="MODULE.General.seo($(this).val());"
...
<script>
    $(function () {
        MODULE.Plugins.upload('manage/attachment/upload_files', true);
    });
</script>
</body>
</html>