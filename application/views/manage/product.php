                ...
                <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                    <div class="inner">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="<?php echo base_url('manage/product/'); ?>" class="active">ÜRÜNLER</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container-fluid container-fixed-lg bg-white">
                <div class="panel panel-transparent">
                    <div class="panel-body">
                        <a href="<?php echo base_url('manage/product/add/'); ?>" class="btn btn-info pull-right"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover" id="basicTable">
                                ...
                                foreach ($list as $k => $v) {
	                                $categoryTitle = '';
	                                $categoryKey = array_search($v['category_id'], array_column($categoryList, 'id'));
                                    if($categoryKey > -1) {
	                                    $categoryTitle = $categoryList[$categoryKey]['title'];
                                    }
                                    ...
                                    <tr>
                                        ...
                                        <td class="v-align-middle"><?php echo $categoryTitle;?></td>
                                        <td class="v-align-middle"><?php echo $v['update_at']; ?></td>
                                        <td class="v-align-middle">
                                            <a href="<?php echo base_url('manage/product/edit/' . $v['id']); ?>"
                                               class="btn"><i class="fa fa-edit"></i></a>
                                        </td>
                                        <td class="v-align-middle"><a
                                                href="<?php echo base_url('manage/product/remove/' . $v['id']); ?>"
